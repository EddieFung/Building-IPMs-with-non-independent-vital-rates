...
gamma = 1
replication = 500
core = 6 #number of cores for used, it took us around 2 hours to finish with 6 cores
source("fn3.R")
n1 = dim(ISSample)[1]
...
id0 = sample(1:n1, replication, replace = TRUE)
id1 = sample(1:n1, replication, replace = TRUE)
iitSample[,6] = iitSample[,6] * gamma 
iitSample[,7] = iitSample[,7] * gamma
temp = mclapply(1:replication, function(x) 
...
iiiSample[,6] = iiiSample[,6] * gamma 
iiiSample[,7] = iiiSample[,7] * gamma 
temp = mclapply(1:replication, function(x) 
...
id0 = sample(1:n1, replication, replace = TRUE)
id1 = sample(1:n1, replication, replace = TRUE)
driSample[,3] = driSample[,3] * gamma 
driSample[,6] = driSample[,6] * gamma 
temp = mclapply(1:replication, function(x) 
...
id0 = sample(1:n1, replication, replace = TRUE)
id1 = sample(1:n1, replication, replace = TRUE)
mitSample[,7] = mitSample[,7] * gamma 
mitSample[,8] = mitSample[,8] * gamma
temp = mclapply(1:replication, function(x) 
  SIM_mit(1000,5000,50,1,4,
          ISSample[id0[x],3:4],ISSample[id0[x],c(1,2,5)],
...
id0 = sample(1:n1, replication, replace = TRUE)
id1 = sample(1:dim(miiSample)[1], replication, replace = TRUE)
miiSample = miiSample[id1,]
miiSample[,7] = miiSample[,7] * gamma 
miiSample[,8] = miiSample[,8] * gamma
temp = mclapply(1:replication, function(x) 
  SIM_mii(50,30,50,1,4,
          ISSample[id0[x],3:4],ISSample[id0[x],c(1,2,5)],
